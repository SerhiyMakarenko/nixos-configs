{
  text = let
    ...
    in builtins.toJSON ({
      color_scheme = if builtins.pathExists (builtins.concatStringsSep "/" ["/home/serhiy_makarenko" draculaPath]) then "Packages/Dracula\ Color\ Scheme/Dracula.tmTheme" else "Monokai.sublime-color-scheme";
